  ...
  return (
    <div className="fixed inset-0 bg-[#242424] z-50 flex items-center justify-center">
      <motion.div
        ...
        initial={false}
        animate={{
          scale: animationPhase === "drawing" ? 0.5 : 1,
        }}
        transition={{
          duration: animationPhase === "scaling" ? 0.8 : 0,
          ease: "easeInOut",
        }}
        onAnimationComplete={() => {
          if (animationPhase === "scaling") {
            setTimeout(() => onComplete(), 500); // Brief pause before hiding
          }
        }}
      >
        <svg
        ...
        >
          ...
          <motion.path
            ...
            animate={{ pathLength: animationPhase === "drawing" ? 1 : 1 }}
          ...
          <motion.path
            ...
            onAnimationComplete={() => {
              if (animationPhase === "drawing") {
                setFillColor("#EDD750"); // Change to your desired fill color
